      ...
      <div class="container d-flex justify-content-center justify-content-md-between">
        ...
        <main class="main">
            <div class="hero">
                ...
                <img
                    style="width: 100vw; object-fit: fill"
                    src="{{ asset('assets/images/lalu lintas.png') }}"
                    alt=""
                />
            </div>
            ...
            <div class="hero">
                ...
                <img
                    style="width: 100vw; object-fit: fill"
                    src="{{ asset('assets/images/lalu lintas2.jpg') }}"
                    alt=""
                />
            </div>
            ...
            <div class="hero">
                ...
                <img
                    style="width: 100vw; object-fit: fill"
                    src="{{ asset('assets/images/lalu lintas3.png') }}"
                    alt=""
                />
            </div>
