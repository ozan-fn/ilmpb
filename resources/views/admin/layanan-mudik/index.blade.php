...
@section('title', 'Layanan Mudik')

@section('content')

    <div class="p-4 sm:ml-64">
        <p class="text-2xl mb-4 font-bold ">Layanan Mudik</p>
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 flex flex-col border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <p class="text-lg mb-4 font-semibold">Gambar Layanan</p>
